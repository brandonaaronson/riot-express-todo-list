...
function updateRemoteApp() {
  return ssh.execCommand(
    'mkdir riot-express-todo-list && cp -r riot-express-todo-list-temp/* riot-express-todo-list-temp/ && rm -rf riot-express-todo-list-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function sshConnect() {
  ...
  ssh
    .connect({
      ...
      host: '3.87.14.67',
      username: 'ubuntu',
      privateKey: 'riot-express-key.ppk'
    })
    .then(function() {
